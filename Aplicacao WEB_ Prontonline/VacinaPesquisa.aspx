...
<%--                    Pegar só Id do UserId
                    SelectCommand="SELECT tv.descricao, v.id_vacina, v.data, v.id_usuario
                    FROM tb_tipoVacina as tv join tb_vacina as v on tv.id_tipoVacina=v.id_tipoVacina
                    WHERE ([descricao] LIKE '%' + @descricao + '%') and v.id_usuario=@id_usuario" --%>
                ...
                <asp:TextBox ID="TextBoxNomeVacina" runat="server" Width="100%" class="ConfTextBox"></asp:TextBox>
                </div>
                <div class="col-md-4">
                <asp:Button ID="ButtonBuscar" runat="server" Text="Buscar" class="ConfButton2" Width="80%" OnClick="ButtonBuscar_Click"/>
                </div>

                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" DataKeyNames="id_vacina">
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        <asp:BoundField DataField="id_usuario" HeaderText="id_usuario" SortExpression="id_usuario" />
                        <asp:BoundField DataField="id_vacina" HeaderText="id_vacina" InsertVisible="False" ReadOnly="True" SortExpression="id_vacina" />
