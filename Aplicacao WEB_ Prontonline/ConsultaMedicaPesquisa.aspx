...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-7 align-left">
            ...
            <br /><br />
            <asp:DataGrid ID="DataGrid1" runat="server" CssClass="ConfGridView" AutoGenerateColumns="False" OnDeleteCommand="DataGrid1_DeleteCommand" OnEditCommand="DataGrid1_EditCommand" OnUpdateCommand="DataGrid1_UpdateCommand" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" Font-Size="Larger" HorizontalAlign="Center" VerticalAlign="Middle" ForeColor="White" />
