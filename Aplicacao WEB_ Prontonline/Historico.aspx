        ...
        <asp:TextBox ID="TextBoxIdSaude" runat="server" Visible="false"></asp:TextBox>
            <div class="row align-left">                        
				<div class="col-md-3 align-left">
                    ...
                    <asp:DropDownList ID="DropDownListAlergia" runat="server" DataSourceID="SqlDataSourceAlergia" DataTextField="descricao" DataValueField="id_tipoAlergia" width="100%" class="ConfTextBox"></asp:DropDownList>
                ...
                <div class="col-md-3 align-left">
                    ...
                    <br />
                    <asp:Button ID="ButtonAdicionarAlergia" runat="server" Text="Adicionar" class="ConfButton2" Width="100%" OnClick="ButtonAdicionarAlergia_Click"/>
                </div>
            ...
            <div class="row align-left">             
				<div class="col-md-3 align-left">
                    ...
                    <asp:DropDownList ID="DropDownListCirurgia" runat="server" DataSourceID="SqlDataSourceCirurgia" DataTextField="descricao" DataValueField="id_tipoCirurgia" width="100%" class="ConfTextBox"></asp:DropDownList>
                ...
                <div class="col-md-3 align-left">
                    ...
                    <asp:TextBox ID="TextBoxData2" runat="server" TextMode="Date" Width="100%"></asp:TextBox>
                    <br />
                    <asp:Button ID="ButtonAdicionarCirurgia" runat="server" Text="Adicionar" CssClass="ConfButton2" Width="100%" OnClick="ButtonAdicionarCirurgia_Click"/>
                </div>
                <div class="col-md-6 align-left">
                    <br />
            ...
            <div class="row align-left">           
				<div class="col-md-3 align-left">
                    ...
                    <asp:DropDownList ID="DropDownListFratura" runat="server" DataSourceID="SqlDataSourceFratura" DataTextField="descricao" DataValueField="id_tipoFratura" width="100%" class="ConfTextBox"></asp:DropDownList>
                ...
                <div class="col-md-3 align-left">
                    ...
                    <asp:TextBox ID="TextBoxData3" runat="server" TextMode="Date" width="100%" class="ConfTextBox"></asp:TextBox>
                    <br/>
                    <asp:Button ID="ButtonAdicionarFratura" runat="server" Text="Adicionar" CssClass="ConfButton2" Width="100%" OnClick="ButtonAdicionarFratura_Click"/>
                </div>
                <div class="col-md-6 align-left">
                    <br />
